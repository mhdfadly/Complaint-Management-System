...
<head>
    ...
    <link rel="stylesheet" href="css/style_detail_komplain.css">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav active ml-auto text-right">
                    <a class="nav-item nav-link" href="#">Status Komplen</a>
            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="complaint">Komplen</label>

                        </div>

                        <div class="row">
                            <div class="col-sm-12">
                                <button type="submit" class="primery-btn">Pilih Teknisi</button>
                            </div>
                        </div>
                    </form>
                </div>
